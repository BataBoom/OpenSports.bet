...
$getscore = "https://api2.dimedata.net/v4/?feedID=1157&api-key=a71b8fe8e9eb957db549aaa5d99797a4&status=Completed";
...
$FHAS[$t] = $scoreG[$t]['scoreAwayPeriod1'];
$FHHS[$t] = $scoreG[$t]['scoreHomePeriod1'];
