...
$(document).ready((function() {
    ...
    if ($("#billboardjs-chart-2").length) bb.generate({
        data: {
            columns: [
                ["data1", 30, 200, 100, 400, 150, 250],
                ["data2", 50, 20, 10, 40, 15, 25]
    ...
    if ($("#billboardjs-chart-3").length) bb.generate({
        data: {
            columns: [
    ...
    if ($("#billboardjs-chart-7").length) bb.generate({
        data: {
            columns: [
    ...
    if ($("#billboardjs-chart-8").length) bb.generate({
        data: {
            columns: [
                ["data1", 30, 200, 100, 400, 150, 250],
                ["data2", 130, 100, 140, 200, 150, 50]
        ...
        var l = bb.generate({
            data: {
                ...
                onclick: function(t, o) {
                    console.log("onclick", t, o)
                },
                onover: function(t, o) {
                    console.log("onover", t, o)
                },
                onout: function(t, o) {
                    console.log("onout", t, o)
                }
            },
            size: {
                height: 280
    ...
    if ($("#billboardjs-chart-14").length) bb.generate({
        data: {
            x: "x",
            columns: [
