...
*/
include_once('includes/odds/mlbOdds.php');
...
$formNames = array('mlb0', 'mlb1', 'mlb2', 'mlb3', 'mlb4', 'mlb5', 'mlb6', 'mlb7', 'mlb8', 'mlb9', 'mlb10', 'mlb11', 'mlb12', 'mlb13','mlb14', 'mlb15', 'mlb16', 'mlb17', 'mlb18', 'mlb19', 'mlb20');
...
$changeRadio = array(
   'inlineRadioLabelClass'     => 'material-radio is-green',
   'wrapElementsIntoLabels'   => false,
   'verticalRadioLabelClass'      => 'material-radio is-green',
   'inlineRadioWrapper' => 'material-radio is-green',
);
...
for($i=0; $i < $CountKeys; ++$i) { 
    for($c = 0; $c < 6; ++$c) { 
$z = range(0,$CountKeys);
$form[$i] = new Form(mlb.$i, $layout = 'vertical', $framework);
...
$form[$i]->addCheckbox($RLMenu[$i], 'Spreads?', 3, unchecked);
...
$form[$i]->addRadio('rlSelection', $rlTeam[$i][0].' '.$rlPrice[$i][0], $rlTeam[$i][0], 'data-oncolor=linear-gradient(140deg\, #fabe1c 35%\, #f88c21)');
$form[$i]->addRadio('rlSelection', $rlTeam[$i][1].' '.$rlPrice[$i][1], $rlTeam[$i][1], 'data-oncolor=linear-gradient(140deg\, #fabe1c 35%\, #f88c21)');
...
$form[$i]->addBtn('submit', 'mlbe', 1, 'Place Wager <i class="fas fa-arrow-right fa-fw"></i>', $attr = 'class=card-footer-item, id=ok', $Menu[$i]);
...
<div id="posts-feed" class="container" data-open-sidebar data-page-title="MLB Odds">
   
  <div class="block"></div>
 <div class="cover-bg">
    <img class="cover-image" src="assets/img/baseball.jpg" data-demo-src="assets/img/baseball.jpg" alt="">
    <div class="avatar">
...
<div class="profile-subheader">
 ...
 <button type="button" id="slip0" onclick="slide(<?php echo $i;?>);" class="button card-header-icon is-small is-clickable">
  <i class="fas fa-angle-down" aria-hidden="true"></i></button>
   ...
   <img src="assets/logos/<?php echo $awayI[$i].'.svg';?>" class="image is-48x48 mr-5 ml-auto">     
        <ul class="quick">
            <p>View: +140 / +7 </p>
            <p>W/L: 36-12</p>
            <p>Public: 26%</p>
      </ul>
   <img src="assets/logos/<?php echo $homeI[$i].'.svg'; ?>" class="image is-48x48 ml-auto mr-5">
         <ul class="quick">
            <p>View: -110 / -7 </p>
            <p>W/L: 36-12</p>
            <p>Public: 56%</p>
