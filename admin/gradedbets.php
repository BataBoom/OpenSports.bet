...
<div class="column is-9">
                ...
                <section class="info-tiles">
                 ...
                 <div class="column">
                    <?php
    $readGradedBets = listGradedBets();
    $end = count($readGradedBets);
    $betID = array_column($readGradedBets, 'id');
    ?>
                    <h1 class="title"><?php echo $end . " Graded Bets";?></h1>
       <h2 class="subtitle"><?php echo countLoseBets(); echo " Losses/Bookie Wins"; ?></h2>
   </div>
               <div class="column">
  ...
  <tbody>
    ...
    <tr>
     ...
     <?php echo "<td>".$readGradedBets[$i]['id']."</td>";?>
      <?php echo "<td>".$readGradedBets[$i]['username']."</td>";?>
     <?php echo "<td>".$readGradedBets[$i]['gameid']."</td>";?>
     <?php echo "<td>".$readGradedBets[$i]['option']."</td>";?>
     <?php echo "<td>".$readGradedBets[$i]['amount']."</td>";?>
    <?php echo "<td>".$readGradedBets[$i]['win_status']."</td>";?>
    <?php echo "<td>".$readGradedBets[$i]['ratio']."</td>";?>
    <?php //echo "<td>".$readGradedBets[$i]['start']."</td>";?>
       <?php echo "<td><a href=" . "edit_bet.php?id=$betID[$i]" . "><ion-icon name='create'></ion-icon>
</span></a></td>";?>
    </tr>
