...
<div id="tabs-with-content">
  <div class="tabs is-toggle is-info is-fullwidth">
    <ul>
       <li>
      <a>
        <span class="icon is-large"><ion-icon name="cash"></ion-icon></span>
        <span>Deposit</span>
      </a>
    </li>
    <li>
      <a>
        <span class="icon is-large"><ion-icon name="logo-bitcoin"></ion-icon></span>
        <span>Withdrawl</span>
      </a>
    </li>
    <li>
